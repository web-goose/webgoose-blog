...
<div class="card my-5 border-0">
    ...
    <div class="card-body p-0">
        ...
        <!-- Creation date -->
        <h6 class="card-subtitle mb-3 text-muted"><?php echo $page->date(); ?> -
            <?php echo $L->get('Reading time') . ': ' . $page->readingTime(); ?></h6>
...
<nav class="paginator">
    <ul class="pagination flex-wrap">
        ...
        <li class="page-item ml-2">
            <a class="page-link" href="<?php echo Paginator::nextPageUrl() ?>"><?php echo $L->get('Next'); ?>
                &#9658;</a>
        </li>
        <?php endif; ?>
